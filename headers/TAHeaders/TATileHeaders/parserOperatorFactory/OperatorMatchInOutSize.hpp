#ifndef UTOTPARSER_OPERATORMATCHINOUTSIZE_H
#define UTOTPARSER_OPERATORMATCHINOUTSIZE_H
...
class OperatorMatchInOutSize : public Operator {

public:
    explicit OperatorMatchInOutSize(DoublyLinkedList<ParserNode> &parserList) : Operator(parserList)
    {};
    ...
    void executeOperator() override
    {
        ...
        Connector *connector = tileConnectorFactory->createConnector(t1, t2, destTile, match_inout_size);
...
#endif //UTOTPARSER_OPERATORMATCHINOUTSIZE_H
