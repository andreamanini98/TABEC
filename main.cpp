...
int main(int argc, char *argv[]) {
    ...
    std::string inputDirPath = cliHandler.isCmd(src) ? (argv[cliHandler.getPos(src) + 1]) : (currentDirPath + "/inputFiles");
    std::string outputDirPath = cliHandler.isCmd(dst) ? (argv[cliHandler.getPos(dst) + 1]) : (currentDirPath + "/outputFiles");
    ...
    deleteDirectoryContents(outputDirPath);
    deleteDirectoryContents(outputDirForCheckingPath);
